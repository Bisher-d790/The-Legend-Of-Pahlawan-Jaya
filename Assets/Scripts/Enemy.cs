...
public class Enemy : MonoBehaviour
{
    ...
    [Tooltip("Child gameObject to detect hit")]
    ...
    [Tooltip("Wait time in secs at waitpoints")]
    ...
    // movement tracking
    [Tooltip("The waypoint the Charachter is moving to")]
    [SerializeField]
    ...
    IEnumerator Stand()
    {
        ...
        {
            if (GetComponent<Archer>().isShooting)
            {
